						...
						<tr style="background-color: rgba(150,150,150,1);">
 						 ...
 						 <?php
 						 	for($i = 0; $i<sizeof($posts); $i++){
								...
								echo '<td class="groupRow">' .$posts[$i]['group_id']. '</td>';
		    					echo '<td class="groupRow">' .$posts[$i]['group_name']. '</td>';
								echo '<td class="groupRow"><button type="button" onclick="redirect_edit(' .$posts[$i]['group_id']. ')">Edit</button></td>' ;
								echo '<td class="groupRow"><button type="button" onclick="redirect_delete(' .$posts[$i]['group_name']. ')">Delete</button></td>';
								echo '</tr>';
							}
						  ?>
					</table>
