...
<html>
	...
	<body onload="drawChart_at_home()">
        ...
        Group Members:<select data-placeholder="Choose a Country..." name="options[]" class="chosen" multiple style="width:350px;" tabindex="4">
...
<br />
										...
										<script type="text/javascript" src ="chosen.jquery.js" />
